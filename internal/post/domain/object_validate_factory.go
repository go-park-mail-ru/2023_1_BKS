...
func CreateImagesAndSpecification(cfg config.Config) ImagesAndSpecification {
	var valid []Specification[string]
	valid = append(valid, CreateImagesLengthValidation(cfg))
	return ImagesAndSpecification{valid}
}

func CreateImagesLengthValidation(cfg config.Config) ImagesWeightValidation {
	return ImagesWeightValidation{cfg.Valid.ImagesValidate.MinLength, cfg.Valid.ImagesValidate.MaxLength, cfg.Valid.ImagesValidate.Weigth}
}
